...
import com.bits.cabs.TripGeneratorSpout;
import com.bits.cabs.UserCount;
import com.bits.cabs.UserExtractor;
...
public class PopularFlavorTopology {
	public static void main(String args[]) {
		...
		builder.setBolt("Flavor Count", new FlavorCounterBolt()).fieldsGrouping("Flavor Extractor", new Fields("flavor"));
